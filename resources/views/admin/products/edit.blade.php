    ...
    <form action="{{ route('update.product',['id' => $product->id]) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="editor" class="form-control">{{ old('content',$product->content) }}</textarea>
                @error('content')
                    <div class="alert-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div id="image_show">
                    <a href="{{ old('file') }}" target="_blank">
                        <img src="{{ old('file',$product->thumb) }}" width="100px">
                    </a>
                </div>
                <input type="hidden" name="thumb" id="thumb" value="{{ old('file',$product->thumb) }}">
